...
- Add Given-When-Then specs to slices (read `references/gwt-specs.md`)
...
- Brainstorm a new feature (read `references/event-storming.md`)
- Add a wireframe to a screen element (read `references/wireframing.md`)
- Add Given-When-Then specs to a slice (read `references/gwt-specs.md`)
